...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/branch/branchSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureBranchCols';
...
const TableSampleBranch = ({
  ...
  useEffect(() => {
    if (branchNotify.showNotification) {
      notify(branchNotify.typeNotification, branchNotify.textNotification);
    }
  }, [branchNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/branch/branch-view/?id=${id}`);
  };
...
export default TableSampleBranch;
